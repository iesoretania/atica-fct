...
class CalendarType extends AbstractType
{
    ...
    {
        $builder
            ->add('start_date', 'Symfony\Component\Form\Extension\Core\Type\DateType', [
                'label' => 'form.start_date',
                'widget' => 'single_text',
                'required' => true
            ])
            ->add('total_hours', 'Symfony\Component\Form\Extension\Core\Type\IntegerType', [
                'attr' => [
                    'min' => 0,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => 'AppBundle\Form\Model\Calendar',
